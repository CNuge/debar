...
#TODO - use the explanations I've written here in the vignette to bolster the documentation. Add detail beyond just a single sentence to the explanations.
#TODO - some of this information is probably better included in the top section of the documentation. i.e. really small level minutiae about the translation tables not needed here.
...
For demonstration of the workflow, `DAPR` contains several example files. The first is a fastq file with series of single molecule, real-time (SMRT) sequencing reads generated on the Pacific BioSciences SEQUEL platform. These data are derived from 5 unique samples animal samples, from which amplicons of the COI-5P (Folmer) region of the mitochondrial cyctochrome c oxidase I gene were isolated and sequenced. 
